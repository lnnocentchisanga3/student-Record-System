 <div class="container">
            	<div class="card ">
            		<div class="card-header">
            			<i class="fa fa-list"></i> Create a TimeTable / First Period
            		</div>
            		<div class="card-body">
            			<form class="col-md-8 offset-md-2" method="POST" action="period.add.php">
            				...
            				<div class="input-group py-2">
            					...
            					<div class="col-md-8">
            						<select type="text" name="course" placeholder="Course Name" class="form-control">
                                                 <?php
                                                 require '../includes/server.connect.php';
                                                $query = "SELECT * FROM course";
                                                $result = mysqli_query($server_connection, $query);
							...
							<div class="input-group offset-md-8 py-2">
								<input type="submit" name="addperiod" class="form-control col-md-4 btn btn-md btn-primary" value="1/3 Next >>">
							</div>
            			</form>
            		</div>
