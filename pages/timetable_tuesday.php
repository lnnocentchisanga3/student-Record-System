 <div class="container">
            	<div class="card ">
            		<div class="card-header">
            			<i class="fa fa-list"></i> Create a TimeTable / Second Period
            		</div>
            		<div class="card-body">
            			<form class="col-md-8 offset-md-2" method="POST" action="period.add2.php">
							...
							<div class="input-group offset-md-8 py-2">
								<input type="submit" name="addperiod" class="form-control col-md-4 btn btn-md btn-primary" value="2/3 Next >>">
							</div>
            			</form>
            		</div>
